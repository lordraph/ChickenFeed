...
public class HelpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationMenuView.addItemDecoration(new DividerItemDecoration(HelpActivity.this, DividerItemDecoration.VERTICAL));
    ...
    public void openNotificationActivity(MenuItem item) {
        Intent intent = new Intent(HelpActivity.this, NotificationActivity.class);
        startActivity(intent);
    }

    public void openSavedActivityActivity(MenuItem item) {
        Intent intent = new Intent(HelpActivity.this, SavedActivityActivity.class);
        startActivity(intent);
    }
