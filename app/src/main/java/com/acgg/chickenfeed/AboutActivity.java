...
public class AboutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationMenuView.addItemDecoration(new DividerItemDecoration(AboutActivity.this, DividerItemDecoration.VERTICAL));
    ...
    public void openNotificationActivity(MenuItem item) {
        Intent intent = new Intent(AboutActivity.this, NotificationActivity.class);
        startActivity(intent);
    }

    public void openSavedActivityActivity(MenuItem item) {
        Intent intent = new Intent(AboutActivity.this, SavedActivityActivity.class);
        startActivity(intent);
    }
