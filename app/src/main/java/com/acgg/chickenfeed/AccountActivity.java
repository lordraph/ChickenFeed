...
public class AccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationMenuView.addItemDecoration(new DividerItemDecoration(AccountActivity.this, DividerItemDecoration.VERTICAL));
    ...
    public void openSavedActivityActivity(MenuItem item) {
        Intent intent = new Intent(AccountActivity.this, SavedActivityActivity.class);
        startActivity(intent);
    }
