...
public class NotificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationMenuView.addItemDecoration(new DividerItemDecoration(NotificationActivity.this, DividerItemDecoration.VERTICAL));
    ...
    public void openSavedActivityActivity(MenuItem item) {
        Intent intent = new Intent(NotificationActivity.this, SavedActivityActivity.class);
        startActivity(intent);
    }

    public void openAboutActivity(MenuItem item) {
        Intent intent = new Intent(NotificationActivity.this, AboutActivity.class);
        startActivity(intent);
    }

    public void openHelpActivity(MenuItem item) {
        Intent intent = new Intent(NotificationActivity.this, HelpActivity.class);
        startActivity(intent);
    }
