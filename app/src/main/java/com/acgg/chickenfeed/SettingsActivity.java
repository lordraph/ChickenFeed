...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationMenuView.addItemDecoration(new DividerItemDecoration(SettingsActivity.this, DividerItemDecoration.VERTICAL));
    ...
    public void openSavedActivityActivity(MenuItem item) {
        Intent intent = new Intent(SettingsActivity.this, SavedActivityActivity.class);
        startActivity(intent);
    }
